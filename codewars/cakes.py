"""
    ...
    Pete can bake (integer). For simplicity there are no units for the 
...
def cakes(recipe, available):
    ...
    for rec, value in recipe.items():
        value_2 = available.get(rec, 0)
        quantity_store.append(value_2//value)
    
    return min(quantity_store)
